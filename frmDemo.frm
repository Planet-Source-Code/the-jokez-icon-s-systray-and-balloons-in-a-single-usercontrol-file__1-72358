...
Begin VB.Form frmDemo 
   Caption         =   "UserControl SysTray - Demo"
   ClientHeight    =   4875
   ClientLeft      =   630
   ClientTop       =   4980
   ClientWidth     =   5370
   ...
   ScaleHeight     =   4875
   ScaleWidth      =   5370
   Begin VB.CommandButton cmdNouvelleForme 
...
Private Sub cmdClignote1_Click()
...
Private Sub cmdAlternanceIcone2_Click()
...
Private Sub Command1_Click()
    Debug.Print Me.Name & " : 1- "; ctlSysTrayBalloon1.Tag
    Debug.Print Me.Name & " : 2- "; ctlSysTrayBalloon2.Tag
End Sub

Private Sub cmdNouvelleForme_Click()
    Set xx = New frmDemoBis
    xx.Show vbModeless
    DoEvents
    Call xx.cmdStartStop_Click
    Call xx.cmdClignote1_Click
    Call xx.cmdAlternanceIcone2_Click
End Sub

Private Sub Form_Load()
    Debug.Print Time, "-----------------------------------------------------------------------"
    Call cmdNouvelleForme_Click
End Sub
